...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Employee employee = crudOperation.updateEmployeById(updatedetails,5);	
		String firstname = employee.getFirstname();
		System.out.println("updated value is "+firstname);
		
		Employee gotid =crudOperation.findById(2);
		gotid.getId();
		System.out.println("is.."+gotid.getId());
		crudOperation.deleteEmployeRecordById(9);  //deleting record number 4
